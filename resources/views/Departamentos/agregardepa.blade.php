...
<form action="{{route('depastore', $Id_locacion)}}" class="form" method="POST" enctype="multipart/form-data">
    @csrf 
...
<!-- titulo central -->        
        <div class="titulo_central">
            <div class="centrar ">
                <label><h2>Registro De Departamentos</h2></label>
            </div>
        </div>
        <br><br>
            ...
            <div class="form-step form-step-active">
                ...
                <div class="input-group">
                    ...
                    <select name="estatus" id="estatus" class="form-control">
                          ...
                          <option value="{{$estatus_depa->Id_estado_ocupacion}}">{{$estatus_depa->Id_estado_ocupacion}} .- {{$estatus_depa->Nombre_estado}}</option>
                          @endforeach
                    </select>
                </div>
                <div class="input-group">
