...
@include('sweetalert::alert')
    <form action="{{route('storeLocs', $idlocacion)}}" class="form" method="POST" enctype="multipart/form-data">
        @csrf 

<!-- titulo central -->        
    <div class="titulo_central">
        <div class="centrar ">
            <label><h2>Registro De Locales</h2></label>
        </div>
    </div>
    <br>
...
<!-- Step 4 -->
            ...
            <!-- foto 6-->
                ...
                <div class="btns-group">
                    <a href="#" class="btn btn-prev">Anterior</a>
                    <input type="submit" value="Guardar y Continuar" class="boton_finalizar" style="width: 200px">
