...
<title>Agregar Locacion Por Secciones</title>
</head>

  <body>
<!-- libreria para usar las alertas-->
@include('sweetalert::alert')
    <form action="{{route('storeseccion')}}" class="form" method="POST" enctype="multipart/form-data">
        @csrf 
...
<!-- titulo central -->        
    <div class="titulo_central">
        <div class="centrar ">
            <label><h2>Locacion Por Secciones</h2></label>
        </div>
    </div>
...
<!-- Step 1 -->
            <div class="form-step form-step-active">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control"  name="total_dep" id="total_dep" placeholder="#">
                </div>
                <div class="input-group">
                    <label for="total_loc">No. Total De Locales</label>
                    <input type="text" class="form-control"  name="total_loc" id="total_loc" placeholder="#">
                </div>
                <div class="input-group">
...
<!-- Step 2 -->
                <div class="form-step">
                    ...
                    <div class="agregarservicio">
                        ...
                        <div class="centrar">
                            <label for="agregarservicio" style="text-align: center"><h3>Si Quieres Añadir Un Nuevo Servicio De Estancia Da Click <a href="{{route('viewservicio_secciones')}}" style="text-decoration: blueviolet">Aqui</a></h3></label>
                        </div>
                    </div>
 <!--  seccion 1 -->
                    <div class="subtitulo">
