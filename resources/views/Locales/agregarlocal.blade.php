...
@include('sweetalert::alert')
    <form action="{{route('storeLoc', $Id_locacion)}}" class="form" method="POST" enctype="multipart/form-data">
        @csrf 

<!-- titulo central -->        
    <div class="titulo_central">
        <div class="centrar ">
            <label><h2>Registro De Local</h2></label>
        </div>
    </div>
    <br>
<!-- Progress bar -->
...
<!-- Step 4 -->
            ...
            <!-- foto 6-->
                ...
                <div class="btns-group">
                    <a href="#" class="btn btn-prev">Anterior</a>
                    <input type="submit" value="Guardar" class="boton_finalizar" style="width: 200px">
