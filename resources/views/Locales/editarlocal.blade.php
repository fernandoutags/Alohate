...
<form action="{{route('update_local', [$locales->Id_local, $servicio_bano[0]->Id_servicio_bano, $plantas_pisos[0]->Id_plantas ] )}}" class="form" method="POST" enctype="multipart/form-data">
    @csrf 
    @method('PUT')
...
<!-- titulo central -->        
    <div class="titulo_central">
        <div class="centrar ">
            <label><h2>Editando Local</h2></label>
        </div>
    </div>
    <br>
<!-- Progress bar -->
...
<!-- Step 1 -->
            ...
            <div class="form-step form-step-active">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control"  name="nombre" id="nombre" placeholder="" value="{{$locales->Nombre_local}}">
                </div>
                <div class="input-group">
                    <label>Estatus Del Departamento:</label>
                    <select name="estatus" id="estatus" class="form-control">
                        <option value="-1" selected disabled>Selecciona una opcion</option>
                        @foreach($estatus_locales as $estatus_local)
                            <option value="{{$estatus_local->Id_estado_ocupacion}}" @if($estatus_local->Id_estado_ocupacion == $locales->Id_estado_ocupacion) selected @endif>{{$estatus_local->Id_estado_ocupacion}} .- {{$estatus_local->Nombre_estado}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="input-group">
                    ...
                    <select name="planta" id="planta" class="form-control">
                        ...
                        <option value="{{$plantas_pisos[0]->Nombre_planta}}" @if($plantas_pisos[0]->Id_local   == $locales->Id_local  ) selected @endif>{{$plantas_pisos[0]->Id_plantas }} .- {{$plantas_pisos[0]->Nombre_planta}}</option>
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control"  name="renta" id="renta" placeholder="$" value="{{$locales->Precio_renta}}">
                </div>
                <div class="input-group">
                    <label for="superficie">Espacio De Superficie:</label>
                    <input type="text" class="form-control"  name="superficie" id="superficie" placeholder="m2" value="{{$locales->Espacio_superficie}}">
                </div>
                <div class="input-group">
                    <label for="nota">Deja Una Nota Por Si Tienes Algo Importante Que Remarcar</label>
                    <textarea name="nota" id="nota" cols="40" rows="10" class="form-control">{{$locales->Nota}}</textarea>
                </div>
                <div class="input-group">
                    <label for="descripcion">Descripcion Del Lugar</label>
                    <textarea name="descripcion" id="descripcion" cols="40" rows="10" class="form-control">{{$locales->Descripcion}}</textarea>
                </div>
                <div class="input-group">
                    <label for="garantia">Deposito De Garantia:</label>
                    <input type="text" class="form-control"  name="garantia" id="garantia" placeholder="$" value="{{$locales->Deposito_garantia_local}}">
                </div>
                    ...
                    <div class="fotos_existentes">
                        <div class="row mt-3 p-3">
                            <div>
                                ...
                                <form action="{{route('destroyimglocal', $foto->Id_foto_lugar )}}" method="post">
                                @csrf
                                <img class="card-img col-md-2 moverfoto" src="{{asset('uploads/locales/').'/'.$foto->Ruta_lugar  }}" alt="">
