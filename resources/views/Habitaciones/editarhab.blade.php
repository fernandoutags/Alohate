...
@include('sweetalert::alert')
    <form action="{{route('update_hab', [$habitaciones->Id_habitacion, $servicio_bano[0]->Id_servicio_bano, $servicio_cama[0]->Id_servicio_cama, $plantas_pisos[0]->Id_plantas ] )}}" class="form" method="POST" enctype="multipart/form-data">
        @csrf 
        @method('PUT')
...
<!-- titulo central -->        
    <div class="titulo_central">
        <div class="centrar">
            <label><h2>Editando habitacion</h2></label>
        </div>
    </div>
...
<!-- Step 1 -->
            <div class="form-step form-step-active">
                ...
                <div class="input-group">
                    <label for="cap_personas">Nombre:</label>
                    <input type="text" class="form-control"  name="nombre" id="nombre" placeholder="" value="{{$habitaciones->Nombre_hab}}">
                </div>
                ...
                <div class="input-group">
                    ...
                    <select name="planta" id="planta" class="form-control">
                        ...
                        <option value="{{$plantas_pisos[0]->Nombre_planta}}" @if($plantas_pisos[0]->Id_habitacion  == $habitaciones->Id_habitacion ) selected @endif>{{$plantas_pisos[0]->Id_plantas }} .- {{$plantas_pisos[0]->Nombre_planta}}</option>
                ...
                <div class="input-group">
                    <label>Estatus De La Habitacion</label>
                    <select name="estatus" id="estatus" class="form-control">
                        <option value="-1" selected disabled>Selecciona una opcion</option>
                        @foreach($estatus_habs as $estatus_hab)
                            <option value="{{$estatus_hab->Id_estado_ocupacion}}" @if($estatus_hab->Id_estado_ocupacion == $habitaciones->Id_estado_ocupacion) selected @endif>{{$estatus_hab->Id_estado_ocupacion}} .- {{$estatus_hab->Nombre_estado}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="input-group">
                    <label for="cap_personas">Capacidad De Personas:</label>
                    <input type="text" class="form-control"  name="cap_personas" id="cap_personas" placeholder="#" value="{{$habitaciones->Capacidad_personas}}">
                </div>
                <div class="input-group">
                    <label for="precio_noche">Precio Por Noche:</label>
                    <input type="text" class="form-control"  name="precio_noche" id="precio_noche" placeholder="$" value="{{$habitaciones->Precio_noche}}">
                </div>
                <div class="input-group">
                    <label for="precio_semana">Precio Por Semana:</label>
                    <input type="text" class="form-control"  name="precio_semana" id="precio_semana" placeholder="$" value="{{$habitaciones->Precio_semana}}">
                </div>
                <div class="input-group">
                    <label for="precio_catorcena">Precio Por Catorcena:</label>
                    <input type="text" class="form-control"  name="precio_catorcena" id="precio_catorcena" placeholder="$" value="{{$habitaciones->Precio_catorcedias}}">
                </div>
                <div class="input-group">
                    <label for="precio_mes">Precio Por Mes:</label>
                    <input type="text" class="form-control"  name="precio_mes" id="pisprecio_mesoprecio_mess" placeholder="$" value="{{$habitaciones->Precio_mes}}">
                </div>
                <div class="input-group">
                    <label for="garantia">Deposito De Garantia:</label>
                    <input type="text" class="form-control"  name="garantia" id="garantia" placeholder="$" value="{{$habitaciones->Deposito_garantia_hab}}">
                </div>
                <div class="input-group">
                    <label for="p_ext_mes">Cobro Por Persona Extra(Mes):</label>
                    <input type="text" class="form-control"  name="p_ext_mes" id="p_ext_mes" placeholder="$" value="{{$habitaciones->Cobro_p_ext_mes_h}}">
                </div>
                <div class="input-group">
                    <label for="p_ext_catorce">Cobro Por Persona Extra(Catorcena):</label>
                    <input type="text" class="form-control"  name="p_ext_catorce" id="p_ext_catorce" placeholder="$" value="{{$habitaciones->Cobro_p_ext_catorcena_h}}">
                </div>
                <div class="input-group">
                    <label for="p_ext_noche">Cobro Por Persona Extra(Noche):</label>
                    <input type="text" class="form-control"  name="p_ext_noche" id="p_ext_noche" placeholder="$" value="{{$habitaciones->Cobro_p_ext_noche_h}}">
                </div>
                <div class="input-group">
                    <label for="c_anticipo_mes">Cobro De Apartado(Mes):</label>
                    <input type="text" class="form-control"  name="c_anticipo_mes" id="c_anticipo_mes" placeholder="$" value="{{$habitaciones->Cobro_anticipo_mes_h}}">
                </div>
                <div class="input-group">
                    <label for="c_anticipo_catorce">Cobro De Apartado(Catorcena):</label>
                    <input type="text" class="form-control"  name="c_anticipo_catorce" id="c_anticipo_catorce" placeholder="$" value="{{$habitaciones->Cobro_anticipo_catorcena_h}}">
                </div>
                <div class="input-group">
                    <label for="superficie">Espacio De Superficie:</label>
                    <input type="text" class="form-control"  name="superficie" id="superficie" placeholder="m2" value="{{$habitaciones->Espacio_superficie}}">
                </div>
                <div class="input-group">
                    <label for="nota">Deja Una Nota Por Si Tienes Algo Importante Que Remarcar</label>
                    <textarea name="nota" id="nota" cols="40" rows="10" class="form-control">{{$habitaciones->Nota}}</textarea>
                </div>
                <div class="input-group">
                    <label for="descripcion">Descripcion Del Lugar</label>
                    <textarea name="descripcion" id="descripcion" cols="40" rows="10" class="form-control">{{$habitaciones->Descripcion}}</textarea>
                </div>
            ...
            <div class="form-step">
                ...
                <div class="input-group">
                    ...
                    <select name="camas_juntas" id="camas_juntas" class="form-control">
                        <option value="-1" disabled selected>Selecciona una opcion</option>
                        <option value="{{$habitaciones->Camas_juntas}}" @if($habitaciones->Id_habitacion ) selected @endif>{{$habitaciones->Camas_juntas}}</option>
...
<!-- Step 5 -->
 ...
 <!-- foto 6-->
                ...
                <div class="centrar">
                    <label><h3>Fotos Existentes De La habitaciones</h3></label>
                </div>
                <div class="input-group">
                    <div class="fotos_existentes">
                        <div class="row mt-3 p-3">
                            <div>
                                ...
                                <form action="{{route('destroyimghab', $foto->Id_foto_lugar )}}" method="post">
                                @csrf
                                <img class="card-img col-md-2 moverfoto" src="{{asset('uploads/habitaciones/').'/'.$foto->Ruta_lugar  }}" alt="">
