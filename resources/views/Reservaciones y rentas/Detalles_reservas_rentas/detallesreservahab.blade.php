   ...
   <div class="seccion_hijo_t"> 
         <div class="seccion_interno_1">
            <div class="centrar_texto">
              ...
              <div class="gris">
               <h6> {{$detallereserva[0]->Nombre_hab}}</h6>
              </div>
            </div>
            ...
            <div class="centrar_texto">
               <p><h5>Precios</h5>
                  <div class="gris">
                     ...
                     <h6>Deposito De Garantia: ${{$detallereserva[0]->Deposito_garantia_hab}}</h6>
                     @if($detallereserva[0]->Tipo_de_cobro == "Noche")  
                     <h6>Cobro Por Persona Extra(Noche): $0</h6>
                     @endif
                     @if($detallereserva[0]->Tipo_de_cobro == "Semana")
                     <h6>Cobro Por Persona Extra(Semana): ${{$detallereserva[0]->Cobro_p_ext_catorcena_h}}</h6>
                     <h6>Cobro De Anticipo(Semana): ${{$detallereserva[0]->Cobro_anticipo_catorcena_h}}</h6>
                     @endif
                     @if($detallereserva[0]->Tipo_de_cobro == "Catorcena")
                     <h6>Cobro Por Persona Extra(Catorcena): ${{$detallereserva[0]->Cobro_p_ext_catorcena_h}}</h6>
                     <h6>Cobro De Anticipo(Catorcena): ${{$detallereserva[0]->Cobro_anticipo_catorcena_h}}</h6>
                     @endif
                     @if($detallereserva[0]->Tipo_de_cobro == "Mes")
                     <h6>Cobro Por Persona Extra(Mes): ${{$detallereserva[0]->Cobro_p_ext_mes_h}}</h6>
                     <h6>Cobro De Anticipo(Mes): ${{$detallereserva[0]->Cobro_anticipo_mes_h}}</h6>
                     @endif
                  </div>
               </p>
            </div>
         ...
         <div class="seccion_interno_1">
            <div class="centrar_texto">
               <p><h5>Botones De Accion</h5>
                  <div class="gris">
                     <button class="btn btn-success clickForm" href="{{route('viewrentarc1hab', [$detallereserva[0]->Id_reservacion, $detallereserva[0]->Id_habitacion, $detallereserva[0]->Id_lugares_reservados ])}}">Pasar a rentar</button>
                    <button class="btn btn-warning clickForm" href="{{route('editarreservahab', [$detallereserva[0]->Id_reservacion, $detallereserva[0]->Id_locacion, $detallereserva[0]->Id_habitacion, $detallereserva[0]->Id_lugares_reservados])}}">Editar</button>
                    <a class="btn btn-danger" href="{{route('viewdeletereservahab')}}">Eliminar</a>
                  </div>
               </p>
            </div>
         </div>
