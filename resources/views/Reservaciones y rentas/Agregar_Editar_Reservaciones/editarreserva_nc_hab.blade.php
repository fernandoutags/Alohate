...
<div class="form">   
<form action="{{route('update_reservahabnc', [$reservacion[0]->Id_reservacion, $reservacion[0]->Id_lugares_reservados ,$Id_locacion, $Id_habitacion])}}" method="POST" enctype="multipart/form-data">
@csrf 
@method('PUT')
