...
<form action="{{route('storereservahaboc', [$totalcocheras[0]->Id_locacion, $habitacion[0]->Id_habitacion ])}}" method="POST" enctype="multipart/form-data">
@csrf 
<input type="text" style="display: none;" id="idcliente" name="selector_cliente" value="">
                    <div class="centrar">
                        <p><h4>Registra Un Nuevo Cliente</h4></p>
                            ...
                            <a href="{{route('viewreservahabnc',[$totalcocheras[0]->Id_locacion, $habitacion[0]->Id_habitacion ])}}"><i class="fa-solid fa-plus"></i></a>
                            </p>
                    </div>
