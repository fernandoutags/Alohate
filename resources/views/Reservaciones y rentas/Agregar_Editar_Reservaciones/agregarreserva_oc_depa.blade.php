...
<form action="{{route('storereservadepoc', [$totalcocheras[0]->Id_locacion, $Id_departamento])}}" method="POST" enctype="multipart/form-data">
@csrf 
<input type="text" style="display: none;" id="idcliente" name="selector_cliente" value="">
                    <div class="centrar">
                        <p><h4>Registra Un Nuevo Cliente</h4></p>
                            ...
                            <a href="{{route('viewreservadepnc',[$totalcocheras[0]->Id_locacion, $Id_departamento])}}"><i class="fa-solid fa-plus"></i></a>
                            </p>
                    </div>
