...
<form action="{{route('update_reservadep', [$reservacion[0]->Id_reservacion, $reservacion[0]->Id_lugares_reservados ,$Id_locacion, $Id_departamento])}}" method="POST" enctype="multipart/form-data">
@csrf 
@method('PUT')
...
<input type="text" style="display: none;" id="idcliente" name="selector_cliente" value="{{$reservacion[0]->Id_cliente}}">
                    <div class="centrar">
                        <p><h4>Registra Un Nuevo Cliente</h4></p>
                            ...
                            <a href="{{route('editarreservadepnc', [$reservacion[0]->Id_reservacion, $reservacion[0]->Id_lugares_reservados ,$Id_locacion, $Id_departamento])}}"><i class="fa-solid fa-plus"></i></a>
                            </p>
                    </div>
