...
<div class="form">   
<form action="{{route('update_reservacasanc', [$reservacion[0]->Id_reservacion, $reservacion[0]->Id_lugares_reservados ,$Id_locacion])}}" method="POST" enctype="multipart/form-data">
@csrf 
@method('PUT')
